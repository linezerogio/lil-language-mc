...
export default function StartSection() {
  ...
  return (
    <div className='h-full flex flex-col justify-between'>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center max-w-[2560px] px-[30px] md:px-[100px] mx-auto flex-1 md:flex-none pb-[27px] md:pb-0">
        <div className="flex-col justify-center items-center flex gap-10 flex-1 md:flex-none">
          <div className="flex-col justify-center items-center flex flex-1 md:flex-none">
          ...
          <div className='flex mt-[30px] justify-center md:h-[73px] w-full md:w-auto gap-2.5 md:hidden'>
            <div
              className={cn(
            ...
            <button className="bg-[#5CE2C7] h-[73px] mx-[25px] rounded-[12px] md:rounded-[25px] text-black text-[18px] w-full md:text-[25px] font-bold md:w-[286px] font-[termina] hidden md:block" onClick={() => router.push(`/freestyle/${difficulty}`)}>PLAY</button>
            <div
              className={cn(
                "bg-[#FFF] dark:bg-[#1C1E1E] flex flex-row relative md:w-[311px] justify-center rounded-[10px] md:rounded-[25px] flex-1 md:flex-none py-3 md:py-0",
          ...
          <button className="bg-[#5CE2C7] py-[10px] px-[20px] mx-[25px] rounded-[12px] text-black dark:text-white text-[18px] md:text-[25px] font-bold font-[termina] block md:hidden w-full" onClick={() => router.push(`/freestyle/${difficulty}`)}>PLAY</button>
