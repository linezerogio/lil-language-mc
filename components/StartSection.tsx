    ...
    return <div className='h-full flex flex-col justify-between'>
        ...
        <div className="flex justify-center items-center max-w-[2560px] w-full md:px-[100px] mx-auto">
            <div className="flex-col justify-center items-center flex gap-10">
                ...
                <div className='flex mt-[30px] justify-center h-[42px] md:h-[73px]'>
                    {/* Desktop View */}
                    <div className="hidden md:flex bg-[#FFF] dark:bg-[#1C1E1E] flex-row relative w-[311px] justify-center z-10 rounded-[25px]">
                        {difficulty === "easy" && !difficultyMenuOpen && <button type="button" onClick={() => handleDifficultyButton("easy")} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[15px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/Easy.svg" height={24.57} width={40} alt={"Easy Icon"} className='mr-[10px] px-[5.775px]' /> Easy</div>
                        ...
                        {difficulty === "medium" && !difficultyMenuOpen && <button type="button" onClick={() => handleDifficultyButton("medium")} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[15px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/Medium.svg" height={24.01} width={40} alt={"Medium Icon"} className='mr-[10px] px-[6.1px]' /> Medium</div>
                            <div><Image src="/icons/ExpandDark.svg" height={20} width={18} alt={"Expand Arrow"} className='dark:hidden ml-[4px] px-[3px] py-[2px]' /><Image src="/icons/Expand.svg" height={20} width={18} alt={"Expand Arrow"} className='hidden dark:block ml-[4px] px-[3px] py-[2px]' /></div>
                        </button>}
                        {difficulty === "hard" && !difficultyMenuOpen && <button type="button" onClick={() => handleDifficultyButton("hard")} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[15px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/Hard.svg" height={26.3} width={40} alt={"Hard Icon"} className='mr-[10px] px-[2.265px]' /> Hard</div>
                            <div><Image src="/icons/ExpandDark.svg" height={20} width={18} alt={"Expand Arrow"} className='dark:hidden ml-[4px] px-[3px] py-[2px]' /><Image src="/icons/Expand.svg" height={20} width={18} alt={"Expand Arrow"} className='hidden dark:block ml-[4px] px-[3px] py-[2px]' /></div>
                        </button>}
                        {difficultyMenuOpen && <div className="flex flex-col absolute bottom-0 bg-[#f4f5f6] dark:bg-[#25292D] w-[311px] rounded-[25px] px-3 shadow-[0_4px_40.6px_rgba(0,0,0,0.25)]">
                            <button type="button" onClick={() => handleDifficultyButton("easy")} className={"px-[10px] py-[15px] mt-[12px] justify-center items-start flex flex-col rounded-xl " + (difficulty === "easy" ? "bg-[#fff] dark:bg-[#1C1E1E]" : "")}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/Easy.svg" height={24.57} width={40} alt={"Easy Icon"} className='mr-[10px] px-[5.775px]' /> Easy</div>
                            ...
                            <button type="button" onClick={() => handleDifficultyButton("medium")} className={"px-[10px] py-[15px] my-[9px] justify-center items-start flex flex-col rounded-xl " + (difficulty === "medium" ? "bg-[#fff] dark:bg-[#1C1E1E]" : "")}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/Medium.svg" height={24.01} width={40} alt={"Medium Icon"} className='mr-[10px] px-[6.1px]' /> Medium</div>
                            ...
                            <button type="button" onClick={() => handleDifficultyButton("hard")} className={"px-[10px] py-[15px] mb-[12px] justify-center items-start flex flex-col rounded-xl " + (difficulty === "hard" ? "bg-[#fff] dark:bg-[#1C1E1E]" : "")}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/Hard.svg" height={26.3} width={40} alt={"Hard Icon"} className='mr-[10px] px-[2.265px]' /> Hard</div>
                    ...
                    <button className="bg-[#5CE2C7] h-[73px] mx-[25px] rounded-[12px] md:rounded-[25px] text-black text-[18px] md:text-[25px] font-bold md:w-[286px] font-[termina] hidden md:block" onClick={() => router.push(`/freestyle/${difficulty}`)}>PLAY</button>
                    ...
                    <div className="hidden md:flex bg-[#FFF] dark:bg-[#1C1E1E] flex-row relative w-[311px] justify-center z-10 rounded-[25px]">
                        {newGameMode === "4-Bar Mode" && !gameModeMenuOpen && <button type="button" onClick={() => handleGameModeButton("4-Bar Mode")} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[25px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/icons/FourBarMode.svg" height={24} width={23} alt={"4-Bar Mode Icon"} className='mr-[10px]' /> 4-Bar Mode</div>
                            <div><Image src="/icons/ExpandDark.svg" height={20} width={18} alt={"Expand Arrow"} className='dark:hidden ml-[4px] px-[3px] py-[2px]' /><Image src="/icons/Expand.svg" height={20} width={18} alt={"Expand Arrow"} className='hidden dark:block ml-[4px] px-[3px] py-[2px]' /></div>
                        </button>}
                        {newGameMode === "Rapid Fire Mode" && !gameModeMenuOpen && <button type="button" onClick={() => { }} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[15px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/icons/RapidFireMode.svg" height={24.01} width={40} alt={"Rapid Fire Mode Icon"} className='mr-[10px] px-[6.1px]' /> Rapid Fire Mode</div>
                            <div><Image src="/icons/ExpandDark.svg" height={20} width={18} alt={"Expand Arrow"} className='dark:hidden ml-[4px] px-[3px] py-[2px]' /><Image src="/icons/Expand.svg" height={20} width={18} alt={"Expand Arrow"} className='hidden dark:block ml-[4px] px-[3px] py-[2px]' /></div>
                        </button>}
                        {newGameMode === "Endless Mode" && !gameModeMenuOpen && <button type="button" onClick={() => { }} className={"justify-between items-center gap-2.5 flex flex-row flex-1 px-[15px]"}>
                            <div className={"text-[25px] font-bold tracking-wider flex flex-row mr-auto"}><Image src="/icons/EndlessMode.svg" height={26.3} width={40} alt={"Endless Mode Icon"} className='mr-[10px] px-[2.265px]' /> Endless Mode</div>
                            <div><Image src="/icons/ExpandDark.svg" height={20} width={18} alt={"Expand Arrow"} className='dark:hidden ml-[4px] px-[3px] py-[2px]' /><Image src="/icons/Expand.svg" height={20} width={18} alt={"Expand Arrow"} className='hidden dark:block ml-[4px] px-[3px] py-[2px]' /></div>
                        </button>}
                        {gameModeMenuOpen && <div className="flex flex-col absolute bottom-0 bg-[#f4f5f6] dark:bg-[#25292D] w-[311px] rounded-[25px] px-3 shadow-[0_4px_40.6px_rgba(0,0,0,0.25)]">
                            <button type="button" onClick={() => handleGameModeButton("4-Bar Mode")} className={"px-[10px] py-[15px] mt-[12px] justify-center items-start flex flex-col rounded-xl " + (newGameMode === "4-Bar Mode" ? "bg-[#fff] dark:bg-[#1C1E1E]" : "")}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/icons/FourBarMode.svg" height={24} width={23} alt={"4-Bar Mode Icon"} className='mr-[18.5px] ml-[8.5px]' /> 4-Bar Mode</div>
                            ...
                            <button type="button" onClick={() => { }} className={"px-[10px] py-[15px] my-[9px] justify-center items-start flex flex-col rounded-xl relative cursor-default"}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/icons/RapidFireMode.svg" height={27} width={21.6} alt={"Rapid Fire Mode Icon"} className='mr-[18.5px] ml-[8.5px]' /> Rapid Fire Mode</div>
                            ...
                            <button type="button" onClick={() => { }} className={"px-[10px] py-[15px] mb-[12px] justify-center items-start flex flex-col rounded-xl relative cursor-default"}>
                                <div className={"text-[25px] font-bold tracking-wider flex flex-row items-center"}><Image src="/icons/EndlessMode.svg" height={12.15} width={25.15} alt={"Endless Mode Icon"} className='mr-[18.5px] ml-[8.5px]' /> Endless Mode</div>
                ...
                <button className="bg-[#5CE2C7] h-[43px] w-[calc(100%-60px)] mx-[30px] rounded-[12px] text-black text-[18px] font-bold font-[termina] block md:hidden -mt-[25px]" onClick={() => router.push(`/freestyle/${difficulty}`)}>PLAY</button>
            </div>
        </div>
